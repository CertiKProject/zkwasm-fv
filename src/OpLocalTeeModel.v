...
(* Translation of the constrains in op_local_tee.rs  *)
...
(* These axioms represent the definitions in etable/op_configure/op_local_get.rs .
   ...
   all the constraints by ops[OpcodeClass::LocalTee], which is written (ops_cell LocalTee) here.
...
Notation is_i32_cell := op_local_tee_is_i32_cell.
Notation offset_cell := op_local_tee_offset_cell.
Notation value_cell := op_local_tee_value_cell.
Notation memory_table_lookup_stack_read := op_local_tee_memory_table_lookup_stack_read.
Notation memory_table_lookup_stack_write := op_local_tee_memory_table_lookup_stack_write.
...
Axiom stack_write :
  alloc_memory_table_lookup_write_cell
    ...
    (fun get => get eid_cell)
    (fun get => MTableModel.LocationType_Stack)
    (fun get => get sp_cell + get offset_cell)
    (fun get => get is_i32_cell)
    (fun get => get value_cell)
    (fun get => get (ops_cell LocalTee)).
