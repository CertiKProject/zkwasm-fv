...
(* Translation of the constrains in op_local_get.rs  *)
...
(* These axioms represent the definitions in etable/op_configure/op_local_get.rs .
   ...
   all the constraints by ops[OpcodeClass::LocalGet], which is written (ops_cell LocalGet) here. 
...
Notation is_i32_cell := op_local_get_is_i32_cell.
Notation offset_cell := op_local_get_offset_cell.
Notation value_cell := op_local_get_value_cell.
Notation memory_table_lookup_stack_read := op_local_get_memory_table_lookup_stack_read.
Notation memory_table_lookup_stack_write := op_local_get_memory_table_lookup_stack_write.
